        ...
        <div className="card">
            <div className="flex flex-col justify-end h-full gap-4">
                ...
                <div className="flex flex-col justify-end h-auto align-middle gap-4">
                    <Link to="/signup">
                        <button class="bg-violet-700 text-white font-semibold py-3 !py-4 rounded-md w-full cursor-pointer">
                            Create Account
                        </button>
                    </Link>
                    <Link to="login">
                        <button class="bg-violet-300 text-gray-900 font-semibold py-3 !py-4 rounded-md w-full cursor-pointer">
